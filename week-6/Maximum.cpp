...
int calculateMaximumSpanningWeight(Edge edges[], int numCities, int numEdges)
{
    ...
    for (int i = 0; i < numEdges; i++)
    {
        ...
        if (root1 != root2)
        {
            maximumSpanningWeight += edges[i].weight;
...
int main()
{
    ...
    int maximumSpanningWeight = calculateMaximumSpanningWeight(edges, numCities, numEdges);
